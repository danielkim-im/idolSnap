...
public class Collection_SnapSmallViewHolder extends RecyclerView.ViewHolder {
    CardView cardView;
    ImageView imageView;
    ...
    public Collection_SnapSmallViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        mainCons = itemView.findViewById(R.id.searchsnap_cons);
    ...
    public void bind(CollectionItem collectionItem) {
        loadSnap(collectionItem.getSnap_id());

        moreBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isHidden == false) {
                    snapMoreOption(collectionItem.getSnap_id(), author_id, collectionItem);
                }
            }
        });
    ...
    private void loadSnap(String snap_id) {
        firestore.collection("snap").document(snap_id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists() && documentSnapshot.getBoolean("visibility_private") == false) {
                    ...
                    cardView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (isHidden == false) {
                                ...
                                fullScreenIntent.putExtra("snap_id", documentSnapshot.getString("snap_id"));
                    ...
                    snap = documentSnapshot.toObject(Snap.class);
                    checkIfHidden(snap.getSnap_id(), snap.getDescription());
                } else {
                    //client is trying to load deleted snap or visibility_private snap
    ...
    private void snapMoreOption(String snap_id, String author_id, CollectionItem collectionItem) {
        ...
        deleteLin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                moreBottomSheet.dismiss();
                deleteSnap(snap_id, author_id, collectionItem);
            }
        });
    ...
    private void deleteSnap(String snap_id, String author_id, CollectionItem collectionItem) {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("snap").document(snap_id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        /*if (HomeFollowingFragment.context !=null){
                            HomeFollowingFragment.updateSnap(itemView.getContext());
                        }else{
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bottomSheetDialog.dismiss();
                snapMoreOption(snap_id, author_id, collectionItem);
            }
        });
