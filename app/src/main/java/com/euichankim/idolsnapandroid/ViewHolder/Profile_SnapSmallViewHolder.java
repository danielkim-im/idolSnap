...
public class Profile_SnapSmallViewHolder extends RecyclerView.ViewHolder {
    CardView cardView;
    ImageView imageView;
    ...
    public Profile_SnapSmallViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    private void snapMoreOption(Snap snap) {
        ...
        reportLin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(itemView.getContext(), "show report list", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                firestore.collection("snap").document(snap.getSnap_id()).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        if (ProfileSnapFragment.mContext != null) {
                            ProfileSnapFragment.updateSnap(ProfileSnapFragment.mContext);
                        } else {
